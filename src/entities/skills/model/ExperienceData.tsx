...
export const ExperienceData:ExperienceState[]=[
    {
        ...
        content:[
            ...
            'Middleware를 활용한 권한 처리 및 리다이렉션 로직을 구성할 수 있습니다.',
            'App Routing과 Page Routing을 통한 경로를 관리 할 수 있습니다.',
            'Parallel + Intercepted Routing을 활용한 모달기능을 구현할 수 있습니다.',
    ...
    },
    {
        ...
        content:[
            ...
            'useActionState을 통한 폼관리를 할 수 있습니다.'
        ]
    },
    {
        title:'Redux',
    ...
    },
    {
        ...
        content:[
            ...
            '호이스팅과 TDZ에 대해 이해하고 있습니다.',
            'Promise를 활용한 비동기 처리를 할 수 있습니다.',
    ...
    },
    {
        ...
        content:[
            '웹 접근성과 SEO를 고려한 시멘틱 마크업 설계가 가능합니다.',
            'CSS 전역 설계와 컴포넌트 기반 스타일링을 구분하여 구성할 수 있습니다.',
            'Flexbox와 Grid를 활용한 레이아웃 구성이 가능합니다.',
            'Styled-component와 Emotion 등 CSS-in-JS에 대한 이해와 활용 경험이 있습니다.',
